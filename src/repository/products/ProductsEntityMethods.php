...
class ProductsEntityMethods
{
    ...
    /**
     * Methods, that create record in 'products' entity in @package public
    ...
    /**
     * Methods, that get all records of 'products' entity in @package public
    ...
    /**
     * Methods, that get record with specified key of 'products' entity in @package public
     * @param PDO $pdo instance of PDO
